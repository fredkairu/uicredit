...
import org.uip.mobilebanking.models.templates.account.AccountType;
...
public class QrCodeGenerator {
    ...
    public static String getAccountDetailsInString(String accountNumber, String officeName,
                                                   org.uip.mobilebanking.ui.enums. AccountType
                                                           accountType) {
        int accountId = -1;
        if (accountType ==  org.uip.mobilebanking.ui.enums.AccountType.SAVINGS) {
            accountId = 0;
        } else if (accountType ==  org.uip.mobilebanking.ui.enums.AccountType.LOAN) {
            accountId = 1;
        }
