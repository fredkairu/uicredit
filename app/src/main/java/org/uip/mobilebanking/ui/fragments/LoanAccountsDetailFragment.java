...
public class LoanAccountsDetailFragment extends BaseFragment implements LoanAccountsDetailView {
    ...
    public static LoanAccountsDetailFragment newInstance(long loanId, String phone, String client_id) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        phoneNumber = preferencesHelper.getMobileNo();
        client_id = ""+preferencesHelper.getClientId();
    ...
    public void showLoanAccountsDetail(LoanWithAssociations loanWithAssociations) {
        ...
        //System.out.println("trouble"+loanWithAssociations.getCanDisburse());
       String datematurity1 = String.valueOf(loanWithAssociations.getTimeline().getExpectedMaturityDate());

        String answer = datematurity1.substring(datematurity1.indexOf("[")+1,datematurity1.indexOf("]"));
        //revoving commas
        String replaceString=answer.replace(',','-');



        System.out.print("trouble"+replaceString);
        ...
        if (loanWithAssociations.getStatus().getActive()) {
            ...
            if (overdueSinceDate == null) {
               ...
               tvDueDateName.setText(replaceString);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_update_loan) {
            ((BaseActivity) getActivity()).replaceFragment(LoanApplicationFragment
                    .newInstance(LoanState.UPDATE, loanWithAssociations, phoneNumber, client_id), true, R.id.container);
            return true;
