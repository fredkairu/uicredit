...
public class HomeActivity extends BaseActivity implements UserDetailsView, NavigationView.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //getSupportActionBar().setLogo(R.drawable.setlogo);
        ...
        if (getIntent() != null && getIntent().getBooleanExtra(getString(R.string.notification),
                false)) {
            replaceFragment(NotificationFragment.newInstance(""+clientId), true, R.id.container);
        }
     ...
     /////////////////////ens
        ...
        fabSpeedDial.setMenuListener(new FabSpeedDial.MenuListener() {
             ...
             @Override
             public boolean onMenuItemSelected(MenuItem menuItem2) {

                 int id2 = menuItem2.getGroupId();
                 if (menuItem2.getTitle().equals("Pay Loan")) {

                     replaceFragment(ClientAccountsFragment.newInstance(AccountType.SAVINGS,"",""),
                             true, R.id.container);

                 } else if (menuItem2.getTitle().equals("Request Loan")) {
                     startActivity(new Intent(HomeActivity.this, LoanApplicationActivity.class));

                 }else if (menuItem2.getTitle().equals("View your status")) {
                     replaceFragment(ClientAccountsFragment.newInstance(AccountType.SAVINGS,"",""),
                             true, R.id.container);

                 }else if (menuItem2.getTitle().equals("Home")) {
                    startActivity(new Intent(HomeActivity.this,HomeActivity.class));

                 }else if (menuItem2.getTitle().equals("Loan Limit")) {
                   // startActivity(new Intent(HomeActivity.this,myloanlimit.class));
                    Intent intent = new Intent(HomeActivity.this,myloanlimit.class);
